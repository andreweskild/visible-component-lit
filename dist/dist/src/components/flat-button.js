...
function (_super) {
  ...
  Object.defineProperty(FlatButton, "styles", {
    get: function get() {
  ...
  FlatButton.prototype.splashOn = function () {
  ...
  FlatButton.prototype.splashOff = function () {
    var splsh = this.shadowRoot.getElementById('splash-box');
  ...
  __decorate([lit_element_1.property({
    type: Boolean
  })], FlatButton.prototype, "autofocus", void 0);

  __decorate([lit_element_1.property({
    type: Boolean
  })], FlatButton.prototype, "disabled", void 0);

  __decorate([lit_element_1.property({
    type: String
  })], FlatButton.prototype, "name", void 0);

  __decorate([lit_element_1.property({
    type: String
  })], FlatButton.prototype, "value", void 0);

  FlatButton = __decorate([lit_element_1.customElement('flat-button')], FlatButton);
  return FlatButton;
}(lit_element_1.LitElement);

var templateObject_1, templateObject_2; //# sourceMappingURL={"version":3,"file":"flat-button.js","sourceRoot":"","sources":["flat-button.ts"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;AAAA,2CAA6E;AAG7E;IAAyB,8BAAU;IADnC;QAAA,qEAwFC;QAtF6B,eAAS,GAAG,KAAK,CAAC;QAClB,cAAQ,GAAG,KAAK,CAAC;QAClB,UAAI,GAAG,EAAE,CAAC;QACV,WAAK,GAAG,EAAE,CAAC;;IAmFxC,CAAC;IAjFC,sBAAW,oBAAM;aAAjB;YACE,OAAO,iBAAG,82CAAA,2yCA+CT,KAAC;QACJ,CAAC;;;OAAA;IAED,6BAAQ,GAAR;QACE,IAAI,KAAK,GAAG,IAAI,CAAC,UAAU,CAAC,cAAc,CAAC,YAAY,CAAC,CAAC;QACzD,IAAI,CAAC,KAAK,CAAC,SAAS,CAAC,QAAQ,CAAC,kBAAkB,CAAC,EAAE;YACjD,KAAK,CAAC,SAAS,CAAC,GAAG,CAAC,kBAAkB,CAAC,CAAC;SACzC;IACH,CAAC;IAED,8BAAS,GAAT;QACE,IAAI,KAAK,GAAG,IAAI,CAAC,UAAU,CAAC,cAAc,CAAC,YAAY,CAAC,CAAC;QACzD,IAAI,KAAK,CAAC,SAAS,CAAC,QAAQ,CAAC,kBAAkB,CAAC,EAAE;YAChD,KAAK,CAAC,SAAS,CAAC,MAAM,CAAC,kBAAkB,CAAC,CAAC;SAC5C;IACH,CAAC;IAED,2BAAM,GAAN;QACE,OAAO,kBAAI,0ZAAA,iIAIS,EAAa,2BACf,EAAc,6BACZ,EAAc,4BACf,EAAa,wBACjB,EAAS,yBACR,EAAU,qEAIzB,KATmB,IAAI,CAAC,QAAQ,EACf,IAAI,CAAC,SAAS,EACZ,IAAI,CAAC,SAAS,EACf,IAAI,CAAC,QAAQ,EACjB,IAAI,CAAC,IAAI,EACR,IAAI,CAAC,KAAK,EAIxB;IACJ,CAAC;IArF2B;QAA3B,sBAAQ,CAAC,EAAC,IAAI,EAAG,OAAO,EAAC,CAAC;iDAAmB;IAClB;QAA3B,sBAAQ,CAAC,EAAC,IAAI,EAAG,OAAO,EAAC,CAAC;gDAAkB;IAClB;QAA1B,sBAAQ,CAAC,EAAC,IAAI,EAAG,MAAM,EAAC,CAAC;4CAAW;IACV;QAA1B,sBAAQ,CAAC,EAAC,IAAI,EAAG,MAAM,EAAC,CAAC;6CAAY;IAJlC,UAAU;QADf,2BAAa,CAAC,aAAa,CAAC;OACvB,UAAU,CAuFf;IAAD,iBAAC;CAAA,AAvFD,CAAyB,wBAAU,GAuFlC"}

//# sourceMappingURL=flat-button.js.map